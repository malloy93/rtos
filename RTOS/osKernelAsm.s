...
start_thread_switch:
    LDR R0, =_ZN6kernel10nextThreadE  // Załaduj adres globalnego wskaźnika do R0
...
PendSV_Handler:
    ...
    LDR R1, =_ZN6kernel14previousThreadE  // Załaduj adres wskaźnika na poprzedni wątek
    LDR R2, [R1]                 // Załaduj wskaźnik na poprzedni wątek
    STR R0, [R2]                 // Zaktualizuj wskaźnik stosu w poprzednim wątku (zapisz PSP bieżącego wątku)

    // Switch to new thread
    LDR R0, =_ZN6kernel10nextThreadE     // Załaduj adres wskaźnika na nowy wątek
